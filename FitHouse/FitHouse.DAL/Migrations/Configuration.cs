namespace FitHouse.DAL.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Entities.FitHouseContext>
    {
        ...
        protected override void Seed(Entities.FitHouseContext context)
        {
            ...
            var permisison21 = new Permission { IsDeleted = false, IsStatic = true };
            ...
            context.Permissions.AddOrUpdate(h => h.PermissionId, permisison21);
            ...
            var permissionTreanslation36 = new PermissionTranslation { Language = "en", Title = "Promotion", Permission = permisison20 };
            var permissionTreanslation35 = new PermissionTranslation { Language = "ar", Title = "ترويج", Permission = permisison20 };
            ...
            var permissionTreanslation37 = new PermissionTranslation { Language = "en", Title = "Sizes", Permission = permisison21 };
            var permissionTreanslation38 = new PermissionTranslation { Language = "ar", Title = "أحجام", Permission = permisison21 };
            context.PermissionTranslations.AddOrUpdate(h => h.PermissionTranslationId, permissionTreanslation37);
            context.PermissionTranslations.AddOrUpdate(h => h.PermissionTranslationId, permissionTreanslation38);
