...
angular.module('home').run(['$templateCache', function($templateCache) {
  $templateCache.put('./app/GlobalAdmin/Program/templates/editProgramMeal.html',
    ...
    '							<select style="width:100% !important" class="form-control select-add-tags pmd-select2-tags" ng-model="editProgramMealCtrl.selectedCategoryId"\n' +
    ...
    '						<div class="col-md-3 form-group pmd-textfield pmd-textfield-floating-label pmd-textfield-floating-label-completed">\n' +
    '							<label for="first-name">{{\'SelectItems\' | translate}}</label>\n' +
    '							<select style="width:100% !important" class="form-control select-add-tags pmd-select2-tags" ng-model="editProgramMealCtrl.selectedItem"\n' +
    ...
    '							<select style="width:100% !important" class="form-control select-add-tags pmd-select2-tags" ng-model="editProgramMealCtrl.selectedItemSize">\n' +
...
angular.module('home').run(['$templateCache', function($templateCache) {
  $templateCache.put('./app/GlobalAdmin/Program/templates/newStepTwo.html',
    ...
    '            <input ng-change="addProgramCtrl.ConvertToNumber();" required type="number" class="mat-input form-control"\n' +
    '                name="programDaysCount" ng-model="addProgramCtrl.ProgramDaysCount" minlength="0" maxlength="2">\n' +
    '\n' +
    '            <div ng-messages="stepTwoProgramForm.programDaysCount.$error">\n' +
    '                <div ng-if="stepTwoProgramForm.programDaysCount.$error.required && !stepTwoProgramForm.programDaysCount.$pristine">\n' +
    ...
    '            <input ng-change="addProgramCtrl.ConvertToNumber();" required type="number" class="mat-input form-control"\n' +
    '                name="mealPerDay" ng-model="addProgramCtrl.MealPerDay" minlength="0" maxlength="2">\n' +
    ...
    '                    {{\'requiredErr\' | translate}}</div>\n' +
    '                <div ng-if="(stepTwoProgramForm.mealPerDay.$error.minlength || stepTwoProgramForm.mealPerDay.$error.maxlength)">\n' +
    '                    {{\'maxlength\' | translate}}</div>\n' +
    '            </div>\n' +
    '        </div>\n' +
    '    </div>\n' +
    ...
    '                                                        ng-model="meal.selectedCategoryId" ng-change="addProgramCtrl.changeCategory(meal.selectedCategoryId,meal)">\n' +
    ...
    '                                                        ng-click="getData(meal.selectedItemSize,counterDay,counterMeal,meal)">\n' +
    '                                                        {{\'addItemBtn\' | translate}}</button>\n' +
    '                                                </div>\n' +
    '                                            </div>\n' +
    '\n' +
    ...
    '                                                                <td><i class="material-icons pmd-md deleteButton cursorPointer font25" ng-click="addProgramCtrl.removeItem(itemSize,meal)">delete</i></td>\n' +
    '                                    \n' +
    '                                                            </tr>\n' +
    '                                                        </tbody>\n' +
    '                                                    </table>\n' +
...
angular.module('home').run(['$templateCache', function($templateCache) {
  $templateCache.put('./app/GlobalAdmin/callCenter/templates/callCenterStepOne.html',
    ...
    '            <div ng-if="newProgramForm.floor.$error.required && !newProgramForm.floor.$pristine">\n' +
    '                {{\'ProgramDaysCountReqError\' | translate}}</div>\n' +
    '            <div ng-if="(newProgramForm.floor.$error.minlength || newProgramForm.floor.$error.maxlength)">\n' +
    ...
    '            ng-model="callCenterCtrl.AppartmentNo" ng-minlength="1" ng-maxlength="4">\n' +
    '        <div ng-messages="newProgramForm.appartmentNo.$error" class="error">\n' +
    '            <div ng-if="newProgramForm.appartmentNo.$error.required && !newProgramForm.appartmentNo.$pristine">\n' +
    '                {{\'ProgramDaysCountReqError\' | translate}}</div>\n' +
    '            <div ng-if="(newProgramForm.appartmentNo.$error.minlength || newProgramForm.appartmentNo.$error.maxlength)">\n' +
    '                {{\'ProgramDaysCountLengthError\' | translate}}</div>\n' +
    '        </div>\n' +
    '    </div>\n' +
    '\n' +
...
angular.module('home').run(['$templateCache', function($templateCache) {
  $templateCache.put('./app/GlobalAdmin/callCenter/templates/customizeStepOne.html',
    ...
    '            type="button" ng-click="$state.go(\'callCenter\');">{{\'Back\' | translate}}</button>\n' +
    '\n' +
    '\n' +
...
angular.module('home').run(['$templateCache', function($templateCache) {
  $templateCache.put('./app/GlobalAdmin/callCenter/templates/customizeStepThree.html',
    ...
    '            <div class="form-group pmd-textfield pmd-textfield-floating-label pmd-textfield-floating-label-completed">\n' +
    '                <label for="first-name">{{\'ProgramDiscount\' | translate}}</label>\n' +
    '                <input minlength="1" maxlength="3" positive ng-change="discountChange();" required type="number"\n' +
    '                    class="mat-input form-control" name="programDiscount"\n' +
    '                    ng-model="orderCustomizeProgramCtrl.ProgramDiscount">\n' +
    '            </div>\n' +
    '            <div ng-messages="newProgram3Form.programDiscount.$error" class="error">\n' +
    '                <div\n' +
    '                    ng-if="(newProgram3Form.programDiscount.$error.minlength || newProgram3Form.programDiscount.$error.maxlength)">\n' +
    '                    {{\'programDiscountLengthError\' | translate}}</div>\n' +
    '            </div>\n' +
    '        </div>\n' +
    '    </div>\n' +
    ...
    '                <input disabled type="number" class="mat-input form-control" name="deliveryPrice"\n' +
    '                    ng-model="orderCustomizeProgramCtrl.DeliveryFees">\n' +
    '            </div>\n' +
    '        </div>\n' +
    '    </div>\n' +
    '\n' +
    ...
    '            <div class="form-group pmd-textfield pmd-textfield-floating-label pmd-textfield-floating-label-completed">\n' +
    '                <label for="first-name">{{\'PriceBeforeDiscount\' | translate}}</label>\n' +
    '                <input disabled type="number" class="mat-input form-control" name="priceBeforeDiscount"\n' +
    '                    ng-model="orderCustomizeProgramCtrl.ProgramTotalPriceBefore">\n' +
    '            </div>\n' +
    '        </div>\n' +
    '    </div>\n' +
    '\n' +
    ...
    '                    ng-model="orderCustomizeProgramCtrl.ProgramTotalPrice">\n' +
    '            </div>\n' +
    '        </div>\n' +
    '    </div>\n' +
    '\n' +
    ...
    '            <div class="form-group pmd-textfield pmd-textfield-floating-label pmd-textfield-floating-label-completed">\n' +
    '                <label>\n' +
    '                    <input type="radio" ng-model="orderCustomizeProgramCtrl.orderType.type" value="delivery">\n' +
    '                    {{\'Deivery\' | translate}}\n' +
    '                </label>\n' +
    '                <label style="margin-left:3em">\n' +
    '                    <input type="radio" ng-model="orderCustomizeProgramCtrl.orderType.type" value="pickup">\n' +
    '                    {{\'Pickup\' | translate}}\n' +
    '                </label>\n' +
    '                <br />\n' +
    '            </div>\n' +
    ...
    '\n' +
    '    <div class="pmd-modal-action text-right">\n' +
    '        {{\'price\' | translate}}:{{ orderProgramsCtrl.TotalPrice}} SR\n' +
    '        <br> {{\'DeliveryPrice\' | translate}}:{{ orderProgramsCtrl.DeliveryFees}} SR\n' +
    '        <br>{{\'orderProgramsCtrl.ProgramDiscount\' | translate}}\n' +
    '        <br>{{\'Total\' | translate}} :{{ orderProgramsCtrl.Total}} SR\n' +
    '        <br>\n' +
    '\n' +
    '        <button style="background-color: #e4e5e6;color: black!important;" class="btn pmd-ripple-effect btn-primary"\n' +
    '            type="button" ng-click="$state.go(\'callCenter\');">{{\'Back\' | translate}}</button>\n' +
    ...
    '             !orderCustomizeProgramCtrl.dateIsValid" class="btn btn-success" name="next" type="button"\n' +
    '            ng-click="orderCustomizeProgramCtrl.AddNewProgram()">\n' +
    '            <i class="fa fa-floppy-o"></i>{{\'Save111\' | translate}}</button>\n' +
    '\n' +
    '    </div>\n' +
    '</form>');
}]);
...
angular.module('home').run(['$templateCache', function($templateCache) {
  $templateCache.put('./app/GlobalAdmin/callCenter/templates/customizeStepTwo.html',
    ...
    '            <label for="first-name">{{\'ProgramDaysCount\' | translate}}</label>\n' +
    '\n' +
    '            <input ng-change="orderCustomizeProgramCtrl.ConvertToNumber();" required type="number"\n' +
    '                class="mat-input form-control" name="programDaysCount" positive\n' +
    ...
    '            class="col-md-3 form-group pmd-textfield pmd-textfield-floating-label pmd-textfield-floating-label-completed">\n' +
    '            <label for="first-name">{{\'MealPerDay\' | translate}}</label>\n' +
    '            <input ng-change="orderCustomizeProgramCtrl.ConvertToNumber();" required type="number" positive\n' +
    ...
    '                                <ul>\n' +
    '                                    <li\n' +
    '                                        ng-repeat="meal in [].constructor(orderCustomizeProgramCtrl.mealsCount)  track by $index">\n' +
    '                                        <h4>\n' +
    '                                            <a ng-init="counterMeal=counterMeal+1;"\n' +
...
angular.module('home').run(['$templateCache', function($templateCache) {
  $templateCache.put('./app/GlobalAdmin/callCenter/templates/orderCustomizeProgram.html',
    ...
    '                                    <i class="fa fa-arrow-left"></i>{{\'PreviousStep\' | translate}}</button>\n' +
    '                                <button style="background-color: #e4e5e6;color: black!important;" ng-disabled="orderCustomizeProgramCtrl.currentStep >= orderCustomizeProgramCtrl.steps.length"\n' +
    '                                    class="btn btn-primary" name="next" type="button" ng-click="orderCustomizeProgramCtrl.gotoStep(orderCustomizeProgramCtrl.currentStep + 1)">{{\'NextSتتتتtep\' | translate}}\n' +
    '                                    <i class="fa fa-arrow-right"></i>\n' +
    '                                </button>\n' +
    '                            </span>\n' +
    '                            <!-- {{orderCustomizeProgramCtrl.Setting.minNoDaysPerProgram}} / {{orderCustomizeProgramCtrl.ProgramDaysCount}} -->\n' +
    ...
    '                                <i class="fa fa-floppy-o"></i>{{\'Save2\' | translate}}</button>\n' +
    '                        </div>\n' +
    '                    </div>\n' +
    '                </div>\n' +
    '            </div>\n' +
...
angular.module('home').run(['$templateCache', function($templateCache) {
  $templateCache.put('./app/GlobalAdmin/callCenter/templates/orderMeals.html',
    ...
    '\n' +
    '                <button ng-disabled="orderMealForm.$invalid || !orderMealsCtrl.dateIsValid"\n' +
...
angular.module('home').run(['$templateCache', function($templateCache) {
  $templateCache.put('./app/GlobalAdmin/callCenter/templates/orderPrograms.html',
    ...
    '                    class="btn pmd-ripple-effect btn-primary" type="button"\n' +
    '                    ng-click="$state.go(\'callCenter\');">{{\'Back\' | translate}}</button>\n' +
    '                    <!-- ng-disabled="orderProgramForm.$invalid || !orderProgramsCtrl.dateIsValid || orderProgramsCtrl.addressValidation == false" -->\n' +
    '                <button\n' +
...
angular.module('home').run(['$templateCache', function($templateCache) {
  $templateCache.put('./app/GlobalAdmin/item/templates/edit.html',
    ...
    '					 ng-model="editItemCtrl.SelectedSize[$index].price"  min="{{editItemForm.SelectedSize[$index].cost}}" ng-maxlength="12">\n' +
    ...
    '					ng-model="editItemCtrl.SelectedSize[$index].totalPrice =  editItemCtrl.SelectedSize[$index].price+ (editItemCtrl.SelectedSize[$index].price * editItemCtrl.item.vat/100) "\n' +
...
angular.module('home').run(['$templateCache', function($templateCache) {
  $templateCache.put('./app/GlobalAdmin/item/templates/new.html',
    ...
    '					ng-model="newItemCtrl.SelectedSize[$index].totalPrice = newItemCtrl.SelectedSize[$index].price+ (newItemCtrl.SelectedSize[$index].price * newItemCtrl.vat/100) "\n' +
    '					 min="1" ng-maxlength="12">\n' +
...
angular.module('home').run(['$templateCache', function($templateCache) {
  $templateCache.put('./app/GlobalAdmin/meal/templates/edit.html',
    ...
    '					<div class="col-md-3 form-group pmd-textfield pmd-textfield-floating-label pmd-textfield-floating-label-completed">\n' +
    '							<label for="first-name">{{\'SelectCategory\' | translate}}</label>\n' +
    '							<select style="width:100% !important" class="form-control select-add-tags pmd-select2-tags" ng-model="editMealCtrl.selectedCategoryId"\n' +
    ...
    '						<div class="col-md-3 form-group pmd-textfield pmd-textfield-floating-label pmd-textfield-floating-label-completed">\n' +
    '							<label for="first-name">{{\'SelectItems\' | translate}}</label>\n' +
    '							<select style="width:100% !important" class="form-control select-add-tags pmd-select2-tags" ng-model="editMealCtrl.selectedItem"\n' +
    ...
    '						<div class="col-md-3 form-group pmd-textfield pmd-textfield-floating-label pmd-textfield-floating-label-completed">\n' +
    '							<label for="first-name">{{\'selectSizeLbl\' | translate}}</label>\n' +
    '							<select style="width:100% !important" class="form-control select-add-tags pmd-select2-tags" ng-model="editMealCtrl.selectedItemSize">\n' +
    ...
    '						ng-model="editMealCtrl.meal.carbs" min="1" ng-maxlength="12">\n' +
    ...
    '						ng-model="editMealCtrl.meal.calories" min="1" ng-maxlength="12">\n' +
    ...
    '						ng-model="editMealCtrl.meal.protein" min="1" ng-maxlength="12">\n' +
    ...
    '					<label for="first-name">{{\'vat\' | translate}} </label>\n' +
    '					<input type="number" readonly ng-change="editMealCtrl.calclulate()" class="mat-input form-control"\n' +
    '						name="vat" ng-model="editMealCtrl.meal.vat" min="1" ng-maxlength="12">\n' +
    ...
    '\n' +
    '					<label for="first-name">{{\'Total\' | translate}} </label>\n' +
    '					<input type="number" readonly class="mat-input form-control" name="totalPrice"\n' +
    ...
    '						name="mealDiscount" ng-model="editMealCtrl.meal.mealDiscount" minlength="1" ng-maxlength="3">\n' +
...
angular.module('home').run(['$templateCache', function($templateCache) {
  $templateCache.put('./app/GlobalAdmin/meal/templates/new.html',
    ...
    '				<div class="col-md-3 form-group pmd-textfield pmd-textfield-floating-label pmd-textfield-floating-label-completed">\n' +
    '					<label for="first-name">{{\'SelectCategory\' | translate}}</label>\n' +
    '					<select style="width:100% !important" class="form-control select-add-tags pmd-select2-tags" ng-model="newMealCtrl.selectedCategoryId"\n' +
    ...
    '				<div class="col-md-3 form-group pmd-textfield pmd-textfield-floating-label pmd-textfield-floating-label-completed">\n' +
    '					<label for="first-name">{{\'SelectItems\' | translate}}</label>\n' +
    '					<select style="width:100% !important" class="form-control select-add-tags pmd-select2-tags" ng-model="newMealCtrl.selectedItem"\n' +
    ...
    '				<div class="col-md-3 form-group pmd-textfield pmd-textfield-floating-label pmd-textfield-floating-label-completed">\n' +
    '					<label for="first-name">{{\'selectSizeLbl\' | translate}}</label>\n' +
    '					<select style="width:100% !important" class="form-control select-add-tags pmd-select2-tags" ng-model="newMealCtrl.selectedItemSize">\n' +
