...
angular.module('home').run(['$templateCache', function($templateCache) {
  $templateCache.put('./app/GlobalAdmin/Address/templates/edit.html',
    ...
    '                            ng-pattern="/^[0-9]{1,5}$/" ng-model="editAddressCtrl.Address.floor" ng-minlength="1"\n' +
    '                            ng-maxlength="4">\n' +
    ...
    '                            ng-pattern="/^[0-9]{1,5}$/" ng-model="editAddressCtrl.Address.appartmentNo" ng-minlength="1"\n' +
    '                            ng-maxlength="4">\n' +
...
angular.module('home').run(['$templateCache', function($templateCache) {
  $templateCache.put('./app/GlobalAdmin/Address/templates/new.html',
    ...
    '                        <label for="first-name">{{\'FLoor\' | translate}}</label>\n' +
    '                        <input required type="number" class="mat-input form-control" name="floor"\n' +
    '                            ng-pattern="/^[0-9]{1,5}$/" ng-model="newAddressCtrl.FLoor" ng-minlength="1"\n' +
    '                            ng-maxlength="4">\n' +
    '                        <div ng-messages="addressForm.floor.$error" class="error">\n' +
    '                            <div ng-if="addressForm.floor.$error.required && !addressForm.floor.$pristine">\n' +
    '                                {{\'ProgramDaysCountReqError\' | translate}}</div>\n' +
    ...
    '                        <label for="first-name">{{\'ApartmentNumber\' | translate}}</label>\n' +
    '                        <input required type="number" class="mat-input form-control" name="appartmentNo"\n' +
    '                            ng-pattern="/^[0-9]{1,5}$/" ng-model="newAddressCtrl.AppartmentNo" ng-minlength="1"\n' +
    '                            ng-maxlength="4">\n' +
    '                        <div ng-messages="addressForm.appartmentNo.$error" class="error">\n' +
    '                            <div\n' +
    '                                ng-if="addressForm.appartmentNo.$error.required && !addressForm.appartmentNo.$pristine">\n' +
...
angular.module('home').run(['$templateCache', function($templateCache) {
  $templateCache.put('./app/GlobalAdmin/customProgram/templates/Custom.html',
    ...
    '                                                                        ng-model="meal.selectedCategoryId" ng-change="CustomCtrl.changeCategory(meal.selectedCategoryId,meal)">\n' +
    ...
    '                                                                    <select style="width:100% !important" class="form-control select-add-tags pmd-select2-tags"\n' +
    '                                                                        ng-model="meal.selectedItem" ng-change="CustomCtrl.changeItem(meal.selectedItem.itemId,meal)">\n' +
    ...
    '                \n' +
    '                                                                <div class="col-md-3 form-group pmd-textfield pmd-textfield-floating-label pmd-textfield-floating-label-completed">\n' +
    '                                                                    <button style="background-color: #e4e5e6;color: black!important;     margin-top: 38px;"\n' +
    ...
    '                                                                                <td><i class="material-icons pmd-md deleteButton cursorPointer font25" ng-click="CustomCtrl.removeItem(itemSize,meal)">delete</i></td>\n' +
    '                                                    \n' +
    '                                                                            </tr>\n' +
    '                                                                        </tbody>\n' +
    '                                                                    </table>\n' +
...
angular.module('home').run(['$templateCache', function($templateCache) {
  $templateCache.put('./app/GlobalAdmin/customProgram/templates/Summary.html',
    ...
    '\n' +
    '										<span class="tab-hide">{{\'Overview\' | translate}}</span>\n' +
    '									</a>\n' +
    '								</li>\n' +
    '							</ul>\n' +
    ...
    '										<ul>\n' +
    '											<li>{{\'OrderCode\' | translate}} :\n' +
    '												<span>#{{CustomCtrl.order.orderCode}}</span>\n' +
    '											</li>\n' +
    '											<li>{{\'Pricelbl\' | translate}}: <span>{{CustomCtrl.order.price}} SR</span>\n' +
    '											</li>\n' +
    '											<li>{{\'Ordertype\' | translate}} :\n' +
    ...
    '\n' +
    '											<li>\n' +
    '												{{\'ProgramDaysCount\' | translate}} :\n' +
    '												<span>{{CustomCtrl.daysCount}}</span>\n' +
    '											</li>\n' +
    '											<li>\n' +
    '												{{\'MealPerDay\' | translate}} : <span>{{CustomCtrl.mealsCount}}</span>\n' +
    '\n' +
    '											</li>\n' +
    '											<li> {{\'startDate\' | translate}}: <span>{{CustomCtrl.startDate}}</span>\n' +
    '											</li>\n' +
    '											<li>{{\'status\' | translate}} :\n' +
    '												<span\n' +
    ...
    '						<h3><span>Check Availability. Call us!</span> +966506139999</h3> <small>We are available 24/7\n' +
...
angular.module('home').run(['$templateCache', function($templateCache) {
  $templateCache.put('./app/GlobalAdmin/customProgram/templates/summaryProgram.html',
    ...
    '                                                <span>#{{CustomCtrl.order.orderCode}}</span>\n' +
    '                                            </li>\n' +
    '                                            <li>{{\'Pricelbl\' | translate}}:\n' +
    '                                                <span>{{CustomCtrl.order.price}} SR</span>\n' +
    '                                            </li>\n' +
    '                                            <!-- <li>Type :\n' +
    ...
    ' \n' +
    '                        <h3>\n' +
    '                            <span>Check Availability. Call us!</span> +966506139999</h3>\n' +
...
angular.module('home').run(['$templateCache', function($templateCache) {
  $templateCache.put('./app/GlobalAdmin/meal/templates/mealDetails.html',
    ...
    '                                                        <span>{{detail.itemSize.sizeNameDictionary[selectedLanguage]}}</span>\n' +
    '                                                    </h3>\n' +
    '                                                    <span class="menu-item">{{detail.itemSize.itemDescriptionDictionary[selectedLanguage]\n' +
    '                                                        }}</span>\n' +
    '                                                    <span> {{\'fat\' | translate}}:{{detail.itemSize.fat}}</span>\n' +
    '                                                    <span> {{\'carbs\' | translate}}:{{detail.itemSize.carbs}}</span>\n' +
    '                                                    <span> {{\'protein\' | translate}}:{{detail.itemSize.protein}}</span>\n' +
    ...
    '                                            </li>\n' +
    '                                            <li>{{\'Total\' | translate}}:\n' +
    '                                                <span style="width: 74px !important;" class="ov-yes">{{mealPrepService.mealPrice}}\n' +
    '                                                    SR</span>\n' +
    '                                            </li>\n' +
    '                                        </ul>\n' +
    '                                    </div>\n' +
    ...
    '                                                    <select style="width:100% !important" ng-required="selectedCountryId > 0"\n' +
    '                                                        class="select-tags form-control pmd-select2-tags" ng-change="regionChange()"\n' +
    '                                                        ng-model="selectedRegionId" ng-options="group.regionId as group.titleDictionary[selectedLanguage] for group in regions">\n' +
    '                                                    </select>\n' +
    '                                                </div>\n' +
    '                                            </div>\n' +
    '                                            <div class="row">\n' +
    '                                                <div class="input-field col s6" ng-show="selectedRegionId > 0">\n' +
    '                                                    <select ng-required="selectedRegionId > 0" style="width:100% !important"\n' +
    '                                                        class="select-tags form-control pmd-select2-tags" ng-change="cityChange()"\n' +
    '                                                        ng-model="selectedCityId" ng-options="group.cityId as group.titleDictionary[selectedLanguage] for group in cities">\n' +
    '                                                    </select>\n' +
    '                                                </div>\n' +
    '                                                <div class="input-field col s6" ng-show="selectedCityId > 0">\n' +
    '                                                    <select ng-required="selectedCityId > 0" style="width:100% !important"\n' +
    '                                                        class="select-tags form-control pmd-select2-tags" ng-change="areaChange()"\n' +
    '                                                        ng-model="selectedAreaId" ng-options="group.areaId as group.titleDictionary[selectedLanguage] for group in area">\n' +
    '                                                    </select>\n' +
    '                                                </div>\n' +
    '                                                <div class="input-field col s6" ng-show="selectedAreaId > 0">\n' +
    '                                                    <select ng-required="selectedAreaId > 0" style="width:100% !important"\n' +
    '                                                        class="select-tags form-control pmd-select2-tags" ng-change="branchChange()"\n' +
    '                                                        ng-model="selectedBranchId" ng-options="group.branchId as group.titleDictionary[selectedLanguage] for group in branchList">\n' +
    '                                                    </select>\n' +
    '                                                </div>\n' +
    '                                            </div>\n' +
    ...
    '                                                <!-- {{areaChanged}} -->\n' +
    '                                                {{orderForm.$invalid}}\n' +
    '                                                {{dateIsValid}}<button style="background-color: #e4e5e6;color: black!important;"\n' +
    '                                                    ng-disabled="areaChanged == false || orderForm.$invalid || selectedBranchId <= 0 || !dateIsValid"\n' +
...
angular.module('home').run(['$templateCache', function($templateCache) {
  $templateCache.put('./app/GlobalAdmin/program/templates/programDetails.html',
    ...
    '                                                                <h4>\n' +
    '                                                                    <a ng-init="counterMeal=counterMeal+1;" ng-click="showDetails = ! showDetails;">{{\'Meal\'\n' +
    '                                                                        | translate}}\n' +
    '                                                                        {{counterMeal=$index+1}}</a>\n' +
    ...
    '                                                                        <label for="first-name">{{\'Item\' | translate}}</label>\n' +
    '                                                                        <ul>\n' +
    '                                                                            <li ng-repeat="detail in progDetailsPrepService.programDetails | filter:{dayNumber:counterDay, mealNumberPerDay: counterMeal} :true ">\n' +
    '                                                                                <div class="res-menu">\n' +
    '\n' +
    '                                                                                    <img src={{detail.itemSize.imageUrl}}\n' +
    '                                                                                        imageonload alt="">\n' +
    ...
    '                                                            <div ng-repeat="address in userAddresses">\n' +
    '                                                                <p>\n' +
    '                                                                    <input ng-change="addressInfo(address)" name="group2"\n' +
    '                                                                        type="radio" id="address{{address.addressId}}"\n' +
    '                                                                        ng-model="addresses.address" value="{{address.addressId}}" />\n' +
    ...
    '                                                        <div class="form-group pmd-textfield pmd-textfield-floating-label pmd-textfield-floating-label-completed">\n' +
    '                                                            <label for="first-name">{{\'Country\' | translate}}</label>\n' +
    '                                                            <select ng-required="orderType.type == \'pickup\'" style="width:100% !important"\n' +
    '                                                                class="select-tags form-control pmd-select2-tags"\n' +
    ...
    '                                                            <label for="first-name">{{\'City\' | translate}}</label>\n' +
    '                                                            <select ng-required="selectedRegionId > 0 && orderType.type == \'pickup\'"\n' +
    ...
    '                                                            <label for="first-name">{{\'Area\' | translate}}</label>\n' +
    '                                                            <select ng-required=" selectedCityId > 0 && orderType.type == \'pickup\'"\n' +
    '                                                                style="width:100% !important" class="select-tags form-control pmd-select2-tags"\n' +
    ...
    '                                                            <select ng-required=" selectedAreaId > 0  && orderType.type == \'pickup\'"\n' +
    ...
    ' \n' +
    '                                            <div class="input-field col s12 m4 l2">\n' +
    '                                                {{\'price\' | translate}}:{{ progDetailsPrepService.price}} SR\n' +
    '                                                <br> {{\'DeliveryPrice\' | translate}}:{{ DeliveryFees}} SR \n' +
    '                                                <br>{{\'ProgramDiscount\' | translate}}\n' +
    '                                                :{{ settingsPrepService.programDiscount}} %\n' +
    '                                                <br>{{\'Total\' | translate}} :{{ Total}} SR\n' +
    '                                                <br>\n' +
    '                                                <button style="background-color: #e4e5e6;color: black!important;"\n' +
...
angular.module('home').run(['$templateCache', function($templateCache) {
  $templateCache.put('./app/GlobalAdmin/user/templates/home.html',
    ...
    '				<!-- HOTEL GRID --\n' +
    '				<!-- <div > --\n' +
    '					<div ng-repeat="n in [] | range:6" ng-click="$state.go(\'mealDetails\', {mealId: mealsPrepService[n].mealId});"\n' +
    '						style="cursor: pointer !important;" ng-if="mealsPrepService[n] != undefined" class="col-md-4">\n' +
...
angular.module('home').run(['$templateCache', function($templateCache) {
  $templateCache.put('./app/GlobalAdmin/register/templates/addUser.html',
    ...
    '                            ng-pattern="/^[0-9]{1,5}$/" ng-model="userCtrl.FLoor" ng-minlength="1" ng-maxlength="4">\n' +
    ...
    '                        <label for="first-name">{{\'ApartmentNumber\' | translate}}</label>\n' +
    '                        <input required type="number" class="mat-input form-control" name="appartmentNo"\n' +
    '                            ng-pattern="/^[0-9]{1,5}$/" ng-model="userCtrl.AppartmentNo"\n' +
